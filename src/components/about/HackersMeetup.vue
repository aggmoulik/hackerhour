    ...
    <v-container class="pa-0 my-0">
        <v-layout wrap align-start justify-start row fill-height class="my-0" >
            ...
            <v-flex xs12 sm7 md8 lg8 class="pa-2 my-0">
                <p class="google-font" style="font-size:120%;">{{hackersMeetup.description}}</p>

                <!-- <p class="google-font grey--text mt-3" style="font-size:120%">{{hackersMeetup.description}}</p> -->
...
<script>
import hackersMeetup from '@/assets/data/hackersMeetup.json'
export default {
    data() {
        return {
            hackersMeetup: hackersMeetup
        }
    },
}
</script>
