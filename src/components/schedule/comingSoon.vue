  ...
  <v-container class="mb-0 pb-0">
    <v-layout wrap align-center justify-center row fill-height>
      <v-flex xs12 sm12 md12 lg12 xl12 class="px-5">
        ...
        >
          <b> <span style="color: #0097a7;">Coming Soon...</span></b>
        </p>
        <p class="google-font">
          This year’s program has been designed to help you sharpen your skills,
          expand your network, and accelerate your personal development.
        </p>
