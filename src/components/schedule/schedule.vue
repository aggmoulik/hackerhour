  ...
  <v-container class="mx-5">
    ...
    >
      ...
      <v-flex v-if="item.sessions.length" xs10 md9 class="pa-3">
        <div
          v-for="(n, index) in item.sessions.length"
          :key="index"
          class="white"
        >
          <div
            v-for="(itemp, index) in item.sessions[index]"
            :key="index"
            class="white"
          >
                ...
                <div v-if="obj == sdata.id" class="py-3 pa-3">
                  <v-layout row wrap>
                    <v-flex
                      xs12
                      class="px-3"
                      :style="{ 'border-left': getBorderColor(sdata.place) }"
                    >
                      ...
                      <v-chip
                        ...
                        small
                        ><v-icon x-small>mdi-av-timer</v-icon>&nbsp;
      ...
      <v-flex xs10 md9 v-else class="pa-3">
        <div
          class="px-3"
          :style="{ 'border-left': getBorderColor(item.place) }"
        >
          <p class="google-font mb-0" style="font-size:120%">
            {{ item.title }}
          </p>
          ...
          >
          <v-chip label class="white--text ml-0" color="pink" v-else small
            ><v-icon x-small>mdi-av-timer</v-icon>&nbsp;
